...
class _OceanStorArray(OceanStorModel):
    ...
    FIELD_PARSER = {
        ...
        'pointRelease': (OceanStorModel._parse_product_version, 'productVersion'),
...
class OceanStorArray(OceanStorBase):
    DEVICE_MODELERS = {'OceanStorArray': _OceanStorArray}
